...
- “Provider of DXClusterCache”: Enter the suggested url (e.g. `https://dxc.wavelog.org/dxcache`) there, or - if you want to use your own DXCluster-Cache - you can download/install a copy from the [DXClusterAPI repository](https://github.com/int2001/DXClusterAPI)
- Adjust “Max age”
...
- [Radio Interface Guide](../../user-guide/integrations/radio-interface.md)  
