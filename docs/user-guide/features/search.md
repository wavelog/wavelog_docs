...
A more sophisticated search is available with the "advanced search". The calls to be displayed are selected via a more or less selfexplaining GUI, which lets you use entries from the database via a dropdown menu. After selecting a keyword, you need to enter a value and how to compare it.

After testing the new query, you have the option to save it for later use.

The button "edit queries" lets you alter already stored queries.
