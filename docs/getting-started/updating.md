...
This is **NOT** how to Migrate from Cloudlog to Wavelog. If you're still using Cloudlog go to [this Wiki Page](https://github.com/wavelog/Wavelog/wiki/How-to-migrate-Cloudlog-to-Wavelog)
...
3. You may have to reset your file ownerships
```
chown -R www-data:www-data /var/www/html
```

4. Reload the Page in Webbrowser 
...
5. Copy the following files and folders from the existing installation to the new folder.
    ...
    - if `$config['userdata'] = "userdata";` was **DISABLED** in your old installation ([more info](https://github.com/wavelog/wavelog/wiki/Centralized-Userdata))
