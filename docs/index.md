...
Wavelog sits on top of a web server, commonly known as <a href="https://en.wikipedia.org/wiki/LAMP_%28software_bundle%29" target="_blank">LAMP Stack</a> which includes the  
